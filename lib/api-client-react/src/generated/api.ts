...
export const getGetCampaignLinkClicksUrl = (id: number,) => {
  ...
  return `/api/campaigns/${id}/link-clicks`
}

/**
 * @summary Per-link click breakdown for a campaign
 */
export const getCampaignLinkClicks = async (id: number, options?: RequestInit): Promise<LinkClickRow[]> => {

  return customFetch<LinkClickRow[]>(getGetCampaignLinkClicksUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetCampaignLinkClicksQueryKey = (id: number,) => {
    return [
    `/api/campaigns/${id}/link-clicks`
    ] as const;
    }


export const getGetCampaignLinkClicksQueryOptions = <TData = Awaited<ReturnType<typeof getCampaignLinkClicks>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCampaignLinkClicks>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCampaignLinkClicksQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCampaignLinkClicks>>> = ({ signal }) => getCampaignLinkClicks(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCampaignLinkClicks>>, TError, TData> & { queryKey: QueryKey }
}

export type GetCampaignLinkClicksQueryResult = NonNullable<Awaited<ReturnType<typeof getCampaignLinkClicks>>>
export type GetCampaignLinkClicksQueryError = ErrorType<unknown>
...
export function useGetCampaignLinkClicks<TData = Awaited<ReturnType<typeof getCampaignLinkClicks>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCampaignLinkClicks>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCampaignLinkClicksQueryOptions(id,options)
